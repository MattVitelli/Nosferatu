...
namespace Gaia.SceneGraph.GameEntities
{
    public class TerrainHeightmap : Terrain
    {
        ...
        void LoadHeightFromTexture()
        {
            ...
            Texture2D tex = GFX.Inst.TerrainGen.GenerateTerrain(1025, 1025, out landmarks);//Texture2D.FromFile(GFX.Device, heightmapFileName);
            tex.Save("TestMap.dds", ImageFileFormat.Dds);
            width = tex.Width;
            depth = tex.Height;
