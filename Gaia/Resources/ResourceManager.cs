...
namespace Gaia.Resources
{
    ...
    public class ResourceManager
    {
        ...
        void RegisterResourceTypes()
        {
            ...
            ResourceTypeDefs[(int)ResourceTypes.TerrainCreationDatablock] = typeof(TerrainCreationDatablock);
            ResourceTypeTokens[(int)ResourceTypes.TerrainCreationDatablock] = "TerrainCreationDatablock";
        }
        ...
        {
            Mesh mesh = (Mesh)GetResource(key, ResourceTypes.Mesh);
            mesh.LoadMesh();
            return mesh;
        }
        ...
        public TerrainCreationDatablock GetTerrainCreationDatablock(string key)
        {
            return (TerrainCreationDatablock)GetResource(key, ResourceTypes.TerrainCreationDatablock);
        }
